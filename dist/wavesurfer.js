/*!
 * wavesurfer 2.2.1 (2019-06-11)
 * https://github.com/misyak/wavesurfer
  ...
  _createClass(SpectrogramPlugin, [{
    ...
    value: function drawSpectrogram(frequenciesData, my) {
      ...
      for (i = 0; i < pixels.length; i++) {
        for (j = 0; j < pixels[i].length; j++) {
          var rgb = my.colorMap[pixels[i][j]];
          my.spectrCc.fillStyle = "rgb(".concat(rgb[0], ", ").concat(rgb[1], ", ").concat(rgb[2], ")");
    ...
    value: function loadFrequenciesData(url) {
      ...
      ajax.on('error', function (e) {
        return _this2.fireEvent('error', 'XHR error: ' + e.target.statusText);
      });
      return ajax;
    }
  }, {
...
var _spectrogram = _interopRequireDefault(__webpack_require__(/*! ./plugin/spectrogram.js */ "./src/plugin/spectrogram.js"));
    ...
    value: function drawBuffer() {
      ...
      if (this.params.partialRender) {
        ...
        if (this.params.visualization === 'spectrogram') {
          ...
          this.sepectrogram = new _spectrogram.default(params, this);
          this.sepectrogram.init(); // seting width
